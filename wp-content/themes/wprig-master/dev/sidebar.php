        ...
        <ul class="article_list01">
            <li class="first">
                <a href="/baby/step/mamadays/" target="_blank">
                    <div class="ph01">
                        <img src="<?php echo get_template_directory_uri() . '/images/temp/' ?>mamadays.jpg" width="120"
                             height="90"
            ...
            <li class="last">
                <a href="/baby/cp/cube-pon-2018aw/" target="_blank">
                    <div class="ph01">
                        <img src="<?php echo get_template_directory_uri() . '/images/temp/' ?>cp_disney.jpg" width="120"
                             height="90"
